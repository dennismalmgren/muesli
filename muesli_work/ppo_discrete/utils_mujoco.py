...
def make_ppo_models_state(proof_environment, device, cfg):
    ...
    anchors = define_uniform_grid_anchors(proof_environment.action_spec_unbatched.space.low, proof_environment.action_spec_unbatched.space.high, action_k)
    ...
    policy_mlp = MLP(
        ...
        out_features=action_k**action_dims,  # for now.
        num_cells=[128, 128],
        device=device,
    )
