...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    from losses import QOrdinalClipPPOLoss
    ...
    actor, critic, support = make_ppo_models(cfg.env.env_name, device=device, cfg=cfg.models)
    ...
    loss_module = QOrdinalClipPPOLoss(
        actor_network=actor,
