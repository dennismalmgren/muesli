...
def main(cfg: "DictConfig"):  # noqa: F821
    ...
    from hgauss_cmpo_utils_mujoco import eval_model, make_env, make_ppo_models
    from hgauss_cmpo_loss import HGaussCMPOLoss
...
#    from torchrl.objectives.value import VTrace
    ...
    actor, critic, reward_predictor, support = make_ppo_models(cfg.env.env_name)
    actor, critic, reward_predictor, support = actor.to(device), critic.to(device), reward_predictor.to(device), support.to(device)
