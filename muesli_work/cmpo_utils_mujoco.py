...
def make_ppo_models_state(proof_environment):
    ...
    return policy_module, value_module, reward_module


def make_ppo_models(env_name):
    proof_environment = make_env(env_name, device="cpu")
    actor, critic, reward_predictor = make_ppo_models_state(proof_environment)
    return actor, critic, reward_predictor
